    ...
    return (
        <nav className="flex bg-white shadow-sm ">
            <div className="w-1/6 shadow-sm flex flex-row items-center py-2 border-r px-4">
                            ...
                            <div className="origin-top-right z-10 absolute right-auto mt-5 w-56 rounded-md shadow-lg">
                                <div className="rounded-md bg-white shadow-xs">
                                    <div className="py-1 flex flex-col" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                        ...
                                        <button onClick={logout} className="w-full bg-white block text-left px-4 py-2 text-xs font-medium leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" >Sign Out</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {
                    dropClicked? 
                        <svg width="1em" onClick={()=>setDropClicked(false)} height="1em" viewBox="0 0 16 16" className="ml-auto cursor-pointer bi bi-x text-gray-800 font-bold" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                        </svg>:
                         <svg onClick={()=>setDropClicked(true)} width="1em" height="1em" viewBox="0 0 16 16" className="cursor-pointer ml-auto bi bi-chevron-down text-gray-800 font-bold" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-1/6 ml-auto flex items-center justify-end px-4 ">
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="cursor-pointer bi bi-camera-video-fill text-blue-500 mr-4 h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="cursor-pointer bi bi-sliders text-blue-500 fill-current h-5 w-5"  xmlns="http://www.w3.org/2000/svg">
