    ...
    <>
      {owner ? (
        <div className="flex flex-col my-2 px-4 items-end w-3/5 ml-auto">
          <div className="bg-gradient-to-tr from-teal-400 to-blue-500  ml-2 px-4 py-2 rounded-xl w-auto">
            <p className="text-sm text-left text-white">{message}</p>
          </div>
        </div>
      ) : (
        <div className="flex flex-col my-2 px-4">
          <div className="flex w-full px-16 py-2">
            <h1 className="text-xs text-gray-600">Ryan Tillaman</h1>
          </div>
