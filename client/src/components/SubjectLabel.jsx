        ...
        <div className="flex flex-col w-full rounded-xl text-gray-800">
            <div className="cursor-pointer w-full  justify-between flex flex-row  py-2 px-1">  
                <div className="flex flex-row items-center" onClick={onSubjectLabelClick}>
                    {
                        showSub?
                        <svg width="1em" height="0.6em" viewBox="0 0 16 16" class="transition duration-500 bi bi-chevron-down text-gray-800 font-bold" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>      
                        </svg>
                        :
                        <svg width="1em" height="0.6em" viewBox="0 0 16 16" class="transition duration-50 bi bi-chevron-right text-gray-800 font-bold" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex ">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="hover:text-blue-500 focus:text-blue-500 bi bi-plus-circle ml-auto" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
           ...
           <ul className={showSub?'show text-xs ml-6 text-xs font-semibold rounded-xl':'hidden'}>
