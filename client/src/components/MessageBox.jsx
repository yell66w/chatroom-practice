...
const MessageBox = () => {
    return (
        <div className="flex mt-auto px-5 py-5">

            <div className="flex items-center bg-gray-100 rounded-xl shadow-lg p-4 w-full">
                ...
                <button className="flex items-center justify-center ml-5 bg-gradient-to-r from-teal-400 to-blue-500 text-white px-4 py-2 rounded-xl text-sm">Send 
                <span className="ml-1">
