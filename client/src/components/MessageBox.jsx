    ...
    return (
        <div className="flex mt-auto">
            ...
            <div className="flex items-center bg-gray-100 shadow-lg p-4 w-full">
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="w-6 h-6 text-gray-800 bi bi-plus-circle-fill mr-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="ml-1">
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="h-3 w-3 bi bi-chevron-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
